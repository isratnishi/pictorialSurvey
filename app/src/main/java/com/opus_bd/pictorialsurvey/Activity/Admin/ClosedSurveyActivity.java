...
public class ClosedSurveyActivity extends AppCompatActivity {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot tempDataSnapShot : dataSnapshot.getChildren()) {
                    ...
                    if (foodItem != null) {
                        if(foodItem.getSurveyCondition().equals("Close"))
                        {
                            models.add(foodItem);
                        }
    ...
    private void initializeVariables() {
        viewItemsAdapter = new ViewItemsAdapter(models, ClosedSurveyActivity.this);
    ...
    public void showDialog() {
        ...
        final Dialog dialog = new Dialog(ClosedSurveyActivity.this);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etUserId.getText().toString().equals("ADMIN") && etPassword.getText().toString().equals("123456")) {
                    Intent intent = new Intent(ClosedSurveyActivity.this, AddNewSurveyActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ClosedSurveyActivity.this, LoginActivity.class);
